/**
 * Script Simple de Migración de Datos
 * 
 * Este script migra datos de SQLite a PostgreSQL usando una conexión directa
 */
...
async function migrateFromSQLite() {
    ...
    const sqliteDb = new Database(join(__dirname, '../data/app.db'), { readonly: true });
